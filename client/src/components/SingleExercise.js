...
export default function SingleExercise() {
    ...
    const handleDeleteExercise = async (exerciseId) => {
        ...
        confirmAlert({
            ...
            message: "Are you sure you want to delete this fitness plan?",
            buttons: [
                {
                    label: "Cancel",
                },
    ...
    return (
        <div className={type === "cardio" ? "single-cardio" : "single-resistance"}>
            <Header />
            <h2 className='title text-center'>Progress Tracking</h2>
            <div className="single-exercise d-flex flex-column align-items-center text-center">
                {type === "cardio" && (<div className='cardio-div '>
                    ...
                    <button className='delete-btn' onClick={() => handleDeleteExercise(id)}>Delete Activity</button>
                </div>)}
                {type === "resistance" && (<div className='resistance-div'>
                    ...
                    <button className='delete-btn' onClick={() => handleDeleteExercise(id)}>Delete Fitness Plan</button>
                </div>)}
            </div>
        </div>
